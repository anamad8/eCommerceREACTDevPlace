...
/* Creo 2 estados, uno para ver si el carrito esta abierto o no 
 y otro para obtener la cantidad de productos que tenemos en el carrito */
    const [cartOpen, setCartOpen] = useState(false);
    const [productsLength, setProductsLength] = useState(0);

// Traido del context los productos del carrito 
...
// obtengo para hacer la compra de mis productos
    function comprar() {
        history('/Comprar') 
    }
        ...
        <div className={style.cartContainer}>
            ...
            {cartItems && cartOpen && (
                <div className={style.cart}>
                    ...
                    <button className={style.btnFinalizar} onClick={comprar}>Finalizar</button>
                </div>
            )}
        </div>
    );
